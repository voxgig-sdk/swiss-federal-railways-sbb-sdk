// Command SwissFederalRailwaysSbb-mcp is an MCP server exposing the SwissFederalRailwaysSbb
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SwissFederalRailwaysSbb_list  — list records of an entity
//	SwissFederalRailwaysSbb_load  — load a single record of an entity
//
