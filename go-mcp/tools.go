...
type Args struct {
	Entity string         `json:"entity" jsonschema:"export | record"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.SwissFederalRailwaysSbbSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "swiss-federal-railways-sbb_list",
		Description: "List records from SwissFederalRailwaysSbb. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "swiss-federal-railways-sbb_load",
		Description: "Load a single record from SwissFederalRailwaysSbb. " +
...
func runOp(client *sdk.SwissFederalRailwaysSbbSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.SwissFederalRailwaysSbbSDK, name string) (sdk.SwissFederalRailwaysSbbEntity, error) {
