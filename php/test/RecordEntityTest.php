...
class RecordEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SWISSFEDERALRAILWAYSSBB_TEST_RECORD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function record_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SWISSFEDERALRAILWAYSSBB_TEST_RECORD_ENTID");
