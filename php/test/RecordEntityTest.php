...
class RecordEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SWISS_FEDERAL_RAILWAYS_SBB_TEST_RECORD_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function record_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SWISS_FEDERAL_RAILWAYS_SBB_TEST_RECORD_ENTID");
