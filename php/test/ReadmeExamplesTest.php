...
// SwissFederalRailwaysSbb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SwissFederalRailwaysSbbSDK::test)
...
{
    private const SDK_CLASS = 'SwissFederalRailwaysSbbSDK';
    ...
    private const SDK_BASE = 'swissfederalrailwayssbb_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../swissfederalrailwayssbb_sdk.php';
