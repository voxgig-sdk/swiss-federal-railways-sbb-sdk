...
// SwissFederalRailwaysSbb SDK utility: graphql
//
...
class SwissFederalRailwaysSbbGraphql
{
    ...
    // equivalent.
    public static function body(SwissFederalRailwaysSbbContext $ctx): mixed
    {
    ...
    public static function errors(SwissFederalRailwaysSbbContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
