...
// SwissFederalRailwaysSbb SDK utility: fetcher

class SwissFederalRailwaysSbbFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SwissFederalRailwaysSbbSDK/1.0)';
    ...
    public static function call(SwissFederalRailwaysSbbContext $ctx, string $fullurl, array $fetchdef): array
    {
