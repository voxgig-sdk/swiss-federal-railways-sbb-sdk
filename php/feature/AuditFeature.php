...
// SwissFederalRailwaysSbb SDK audit feature
...
class SwissFederalRailwaysSbbAuditFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _emit(SwissFederalRailwaysSbbContext $ctx, string $outcome): void
    {
