...
// SwissFederalRailwaysSbb SDK telemetry feature
...
class SwissFederalRailwaysSbbTelemetryFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _close(SwissFederalRailwaysSbbContext $ctx, bool $ok): void
    {
