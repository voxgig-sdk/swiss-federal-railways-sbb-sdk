...
// SwissFederalRailwaysSbb SDK timeout feature
...
class SwissFederalRailwaysSbbTimeoutFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _with_timeout(SwissFederalRailwaysSbbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SwissFederalRailwaysSbbContext $_ctx, float $ms): void
    {
        $client = $this->client;
