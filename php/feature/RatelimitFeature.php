...
// SwissFederalRailwaysSbb SDK ratelimit feature
...
class SwissFederalRailwaysSbbRatelimitFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _acquire(SwissFederalRailwaysSbbContext $ctx): void
    {
    ...
    private function _track(SwissFederalRailwaysSbbContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
