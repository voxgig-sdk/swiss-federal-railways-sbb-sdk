...
// SwissFederalRailwaysSbb SDK netsim feature
...
class SwissFederalRailwaysSbbNetsimFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _simulate(SwissFederalRailwaysSbbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SwissFederalRailwaysSbbContext $ctx, array $applied): void
    {
        $client = $this->client;
