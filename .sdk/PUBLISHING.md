...
|---|---|---|
| `ts/` | @voxgig-sdk/swiss-federal-railways-sbb-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/swiss-federal-railways-sbb-sdk \
      --repository voxgig-sdk/swiss-federal-railways-sbb-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/swiss-federal-railways-sbb-sdk` shows it, and
`npm trust revoke @voxgig-sdk/swiss-federal-railways-sbb-sdk --id=<id>` removes it.
