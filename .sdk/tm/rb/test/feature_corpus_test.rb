# SwissFederalRailwaysSbb SDK feature corpus test
#
...
class FeatureCorpusTest < Minitest::Test
  ...
  #
  # SwissFederalRailwaysSbbSDK.new, not SwissFederalRailwaysSbbSDK.test: the `test` feature is
  ...
  def build_client(kase)
    ...
    SwissFederalRailwaysSbbSDK.new(opts)
  end
