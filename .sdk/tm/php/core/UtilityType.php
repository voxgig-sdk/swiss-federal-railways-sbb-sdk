...
// SwissFederalRailwaysSbb SDK utility type

class SwissFederalRailwaysSbbUtility
{
    ...
    public static function copy(SwissFederalRailwaysSbbUtility $src): SwissFederalRailwaysSbbUtility
    {
        $u = new SwissFederalRailwaysSbbUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
