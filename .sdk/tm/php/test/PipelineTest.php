...
// SwissFederalRailwaysSbb SDK pipeline test
//
...
{
    private static function utility(): SwissFederalRailwaysSbbUtility
    {
        return new SwissFederalRailwaysSbbUtility();
    }
    ...
    private static function ctx(array $over = []): SwissFederalRailwaysSbbContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new SwissFederalRailwaysSbbContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new SwissFederalRailwaysSbbOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof SwissFederalRailwaysSbbError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new SwissFederalRailwaysSbbOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = SwissFederalRailwaysSbbMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new SwissFederalRailwaysSbbOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = SwissFederalRailwaysSbbMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new SwissFederalRailwaysSbbOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = SwissFederalRailwaysSbbMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SwissFederalRailwaysSbbSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = SwissFederalRailwaysSbbMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new SwissFederalRailwaysSbbResponse([]),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        [, $err] = SwissFederalRailwaysSbbMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new SwissFederalRailwaysSbbSpec([]),
            'response' => null,
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        [, $err] = SwissFederalRailwaysSbbMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's']),
            'response' => new SwissFederalRailwaysSbbResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        [, $err] = SwissFederalRailwaysSbbMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's']),
            'response' => new SwissFederalRailwaysSbbResponse(self::resp(200, ['v' => 1])),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        [, $err] = SwissFederalRailwaysSbbMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's']),
            'response' => new SwissFederalRailwaysSbbResponse(self::resp(200, ['v' => 2])),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        SwissFederalRailwaysSbbMakeResponse::call($ctx);
    ...
    {
        $preset = new SwissFederalRailwaysSbbResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new SwissFederalRailwaysSbbSpec([]),
            'response' => new SwissFederalRailwaysSbbResponse([]),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ...
        [$got, $err] = SwissFederalRailwaysSbbMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new SwissFederalRailwaysSbbResult([])]);
        [, $err] = SwissFederalRailwaysSbbMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new SwissFederalRailwaysSbbSpec([]), 'result' => null]);
        [, $err] = SwissFederalRailwaysSbbMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's']),
            'result' => new SwissFederalRailwaysSbbResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new SwissFederalRailwaysSbbOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SwissFederalRailwaysSbbMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's']),
            'result' => new SwissFederalRailwaysSbbResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new SwissFederalRailwaysSbbOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = SwissFederalRailwaysSbbMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new SwissFederalRailwaysSbbResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new SwissFederalRailwaysSbbSpec([]),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = SwissFederalRailwaysSbbMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SwissFederalRailwaysSbbMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new SwissFederalRailwaysSbbError('boom', 'boom');
        $utility->fetcher = function (SwissFederalRailwaysSbbContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = SwissFederalRailwaysSbbMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (SwissFederalRailwaysSbbContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = SwissFederalRailwaysSbbMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(SwissFederalRailwaysSbbResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        SwissFederalRailwaysSbbMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (SwissFederalRailwaysSbbContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new SwissFederalRailwaysSbbSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = SwissFederalRailwaysSbbMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new SwissFederalRailwaysSbbResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new SwissFederalRailwaysSbbSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = SwissFederalRailwaysSbbMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = SwissFederalRailwaysSbbMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = SwissFederalRailwaysSbbMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new SwissFederalRailwaysSbbResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, SwissFederalRailwaysSbbDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new SwissFederalRailwaysSbbResult(['ok' => false])]);
        $this->expectException(SwissFederalRailwaysSbbError::class);
        SwissFederalRailwaysSbbDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new SwissFederalRailwaysSbbResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', SwissFederalRailwaysSbbMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        SwissFederalRailwaysSbbMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new SwissFederalRailwaysSbbBaseFeature();
        $b = new SwissFederalRailwaysSbbBaseFeature();
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, $a);
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): SwissFederalRailwaysSbbBaseFeature
    {
        $f = new SwissFederalRailwaysSbbBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, self::named_feature('a'));
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, $replace);
        ...
        SwissFederalRailwaysSbbFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): SwissFederalRailwaysSbbContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new SwissFederalRailwaysSbbSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = SwissFederalRailwaysSbbPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        SwissFederalRailwaysSbbPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new SwissFederalRailwaysSbbResponse(['headers' => null]),
            'result' => new SwissFederalRailwaysSbbResult([]),
        ]);
        SwissFederalRailwaysSbbResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        SwissFederalRailwaysSbbResultBody::call($ctx);
