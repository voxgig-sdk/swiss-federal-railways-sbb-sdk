...
// SwissFederalRailwaysSbb SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SwissFederalRailwaysSbbOmni::makeStructRunner(
    ...
    {
        return SwissFederalRailwaysSbbOmni::objmodel(SwissFederalRailwaysSbbOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return SwissFederalRailwaysSbbOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return SwissFederalRailwaysSbbOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SwissFederalRailwaysSbbOmni::structfix($now, Struct::undef()))
                        !== json_encode(SwissFederalRailwaysSbbOmni::structfix($val, Struct::undef()))) {
