...
// SwissFederalRailwaysSbb SDK clienttrack feature
...
class SwissFederalRailwaysSbbClienttrackFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    public function PostConstruct(SwissFederalRailwaysSbbContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SwissFederalRailwaysSbb-SDK';
