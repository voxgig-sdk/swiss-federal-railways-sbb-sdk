...
// SwissFederalRailwaysSbb SDK proxy feature
...
class SwissFederalRailwaysSbbProxyFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    public function init(SwissFederalRailwaysSbbContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SwissFederalRailwaysSbbContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
