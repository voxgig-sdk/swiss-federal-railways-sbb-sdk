...
// SwissFederalRailwaysSbb SDK streaming feature
...
class SwissFederalRailwaysSbbStreamingFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _iterate(SwissFederalRailwaysSbbResult $result): \Generator
    {
    ...
    private function _streamable(SwissFederalRailwaysSbbContext $ctx): bool
    {
