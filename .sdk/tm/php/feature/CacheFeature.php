...
// SwissFederalRailwaysSbb SDK cache feature
...
class SwissFederalRailwaysSbbCacheFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _through(SwissFederalRailwaysSbbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
