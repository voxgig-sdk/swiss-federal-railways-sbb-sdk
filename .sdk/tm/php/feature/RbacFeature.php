...
// SwissFederalRailwaysSbb SDK rbac feature
...
class SwissFederalRailwaysSbbRbacFeature extends SwissFederalRailwaysSbbBaseFeature
{
    ...
    private function _required(SwissFederalRailwaysSbbContext $ctx): ?string
    {
    ...
    private function _reject(SwissFederalRailwaysSbbContext $ctx, string $required): void
    {
    ...
    private function _track(SwissFederalRailwaysSbbContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
