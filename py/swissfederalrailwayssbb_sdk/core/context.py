...
from swissfederalrailwayssbb_sdk.core.control import SwissFederalRailwaysSbbControl
...
from swissfederalrailwayssbb_sdk.core.helpers import get_ctx_prop, to_map
...
class SwissFederalRailwaysSbbContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SwissFederalRailwaysSbbControl()
        ...
        if isinstance(sp, SwissFederalRailwaysSbbSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SwissFederalRailwaysSbbResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SwissFederalRailwaysSbbResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SwissFederalRailwaysSbbOperation({})
        ...
        op = SwissFederalRailwaysSbbOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return SwissFederalRailwaysSbbError(code, msg, self)
