...
from swissfederalrailwayssbb_sdk.utility import register

# Load features
from swissfederalrailwayssbb_sdk.feature.base_feature import SwissFederalRailwaysSbbBaseFeature
from swissfederalrailwayssbb_sdk.features import _has_feature, _make_feature
...
class SwissFederalRailwaysSbbSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = SwissFederalRailwaysSbbUtility()
        self._utility = utility

        from swissfederalrailwayssbb_sdk.config import shared_config
    ...
    def get_utility(self):
        return SwissFederalRailwaysSbbUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SwissFederalRailwaysSbbSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Export(self, data=None) -> "ExportEntity":
        ...
        from swissfederalrailwayssbb_sdk.entity.export_entity import ExportEntity
    ...
    def Record(self, data=None) -> "RecordEntity":
        ...
        from swissfederalrailwayssbb_sdk.entity.record_entity import RecordEntity
