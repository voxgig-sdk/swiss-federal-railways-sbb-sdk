...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Export()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk/releases)) or
...
```
py/
├── swissfederalrailwayssbb_sdk.py         -- Main SDK module
