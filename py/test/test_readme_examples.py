# SwissFederalRailwaysSbb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SwissFederalRailwaysSbbSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SwissFederalRailwaysSbbSDK(...) and SwissFederalRailwaysSbbSDK.test(...) become
#      SwissFederalRailwaysSbbSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "swissfederalrailwayssbb_sdk"
_SDK_CLASS = "SwissFederalRailwaysSbbSDK"
