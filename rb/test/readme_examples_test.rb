...
#      offline in seeded test mode (SwissFederalRailwaysSbbSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SwissFederalRailwaysSbb_sdk.rb")
  SDK_CLASS = "SwissFederalRailwaysSbbSDK"
  ...
  SDK_BASE = "SwissFederalRailwaysSbb_sdk"
