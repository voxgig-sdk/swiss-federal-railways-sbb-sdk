...
class RecordEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SWISSFEDERALRAILWAYSSBB_TEST_RECORD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def record_basic_setup(extra)
  ...
  entid_env_raw = ENV["SWISSFEDERALRAILWAYSSBB_TEST_RECORD_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["SWISSFEDERALRAILWAYSSBB_TEST_RECORD_ENTID"])
