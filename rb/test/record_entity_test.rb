...
class RecordEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SWISS_FEDERAL_RAILWAYS_SBB_TEST_RECORD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def record_basic_setup(extra)
  ...
  entid_env_raw = ENV["SWISS_FEDERAL_RAILWAYS_SBB_TEST_RECORD_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["SWISS_FEDERAL_RAILWAYS_SBB_TEST_RECORD_ENTID"])
