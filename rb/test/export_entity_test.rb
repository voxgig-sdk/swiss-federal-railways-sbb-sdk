...
class ExportEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set SWISSFEDERALRAILWAYSSBB_TEST_EXPORT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def export_basic_setup(extra)
  ...
  entid_env_raw = ENV["SWISSFEDERALRAILWAYSSBB_TEST_EXPORT_ENTID"]
