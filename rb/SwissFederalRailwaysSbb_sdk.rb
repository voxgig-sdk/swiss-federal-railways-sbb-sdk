...
require_relative 'SwissFederalRailwaysSbb_types'
...
class SwissFederalRailwaysSbbSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = SwissFederalRailwaysSbbHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = SwissFederalRailwaysSbbHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, SwissFederalRailwaysSbbFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    SwissFederalRailwaysSbbUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = SwissFederalRailwaysSbbHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = SwissFederalRailwaysSbbHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = SwissFederalRailwaysSbbHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => SwissFederalRailwaysSbbError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue SwissFederalRailwaysSbbError => err
    ...
    if fetched.is_a?(Hash)
      status = SwissFederalRailwaysSbbHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = SwissFederalRailwaysSbbError.new(
        "graphql_error", "SwissFederalRailwaysSbbSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = SwissFederalRailwaysSbbSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
