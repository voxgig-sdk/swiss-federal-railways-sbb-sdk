...
The Ruby SDK for the SwissFederalRailwaysSbb API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `SwissFederalRailwaysSbbError` (a `StandardError` subclass), so wrap
