...
const SwissFederalRailwaysSbbError_1 = require("./SwissFederalRailwaysSbbError");
...
class Context {
    ...
    error(code, msg) {
        return new SwissFederalRailwaysSbbError_1.SwissFederalRailwaysSbbError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
