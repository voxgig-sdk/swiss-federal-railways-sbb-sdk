...
(0, node_test_1.describe)('RecordDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SwissFederalRailwaysSbbSDK({
    ...
    (0, node_test_1.test)('direct-list-record', async (t) => {
        ...
        const result = await client.direct({
            path: 'catalog/datasets/ist-daten-sbb/records',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SwissFederalRailwaysSbbSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['SWISS_FEDERAL_RAILWAYS_SBB_TEST_RECORD_ENTID'];
    ...
    const client = new __1.SwissFederalRailwaysSbbSDK({
        base: 'http://localhost:8080',
