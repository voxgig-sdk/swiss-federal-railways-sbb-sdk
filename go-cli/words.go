...
func registerSDKWords(r *eng.Registry, client *sdk.SwissFederalRailwaysSbbSDK) {
...
func runOp(client *sdk.SwissFederalRailwaysSbbSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
