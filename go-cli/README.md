...
AQL-driven CLI and REPL for the SwissFederalRailwaysSbb SDK. Positional arguments are
...
```sh
go build -o swiss-federal-railways-sbb-cli ./...
```
...
./swiss-federal-railways-sbb-cli load 1 export
./swiss-federal-railways-sbb-cli load '{id:1}' export
