...
const testSeed = `map[string]any{"entity": map[string]any{"export": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "record": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
