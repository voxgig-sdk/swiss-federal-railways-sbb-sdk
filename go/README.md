...
The Golang SDK for the SwissFederalRailwaysSbb API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk=../path/to/github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk
```
...
```
github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk/
...
The root package (`github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk`) re-exports everything needed
