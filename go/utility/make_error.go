...
import "github.com/voxgig-sdk/swiss-federal-railways-sbb-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.SwissFederalRailwaysSbbError{
	...
	if se, ok := err.(*core.SwissFederalRailwaysSbbError); ok {
		sdkErr.Code = se.Code
	}
