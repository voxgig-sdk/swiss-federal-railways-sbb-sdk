...
type SwissFederalRailwaysSbbSDK struct {
	Mode     string
...
func NewSwissFederalRailwaysSbbSDK(options map[string]any) *SwissFederalRailwaysSbbSDK {
	sdk := &SwissFederalRailwaysSbbSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *SwissFederalRailwaysSbbSDK) OptionsMap() map[string]any {
...
func (sdk *SwissFederalRailwaysSbbSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SwissFederalRailwaysSbbSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SwissFederalRailwaysSbbSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SwissFederalRailwaysSbbSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SwissFederalRailwaysSbbSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SwissFederalRailwaysSbbSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SwissFederalRailwaysSbbSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SwissFederalRailwaysSbbSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SwissFederalRailwaysSbbSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SwissFederalRailwaysSbbSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *SwissFederalRailwaysSbbSDK {
	...
	sdk := NewSwissFederalRailwaysSbbSDK(sdkopts)
	sdk.Mode = "test"
